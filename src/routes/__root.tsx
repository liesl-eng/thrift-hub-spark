    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That page might still be on the truck. Head back home and we'll find it.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Comeback Restock - Sustainable Sourcing. Premium Results." },
      { name: "author", content: "Comeback Restock" },
      { property: "og:title", content: "Comeback Restock — Returned inventory for thrift retailers" },
      { property: "og:description", content: "Comeback Restock - Sustainable Sourcing. Premium Results." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Comeback Restock — Returned inventory for thrift retailers" },
      { name: "twitter:description", content: "Comeback Restock - Sustainable Sourcing. Premium Results." },
