...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Comeback Restock — Sustainable Sourcing. Premium Results." },
      { name: "description", content: "Premium, inspected home goods sourced for sustainably-minded boutique retailers. Inventory with intention." },
      { name: "author", content: "Comeback Restock" },
      { property: "og:title", content: "Comeback Restock — Sustainable Sourcing. Premium Results." },
      { property: "og:description", content: "Premium, inspected home goods sourced for sustainably-minded boutique retailers. Inventory with intention." },
